...
$uvjet="";
		...
		$poStranici=9;
			...
			$izraz = $veza -> prepare("
			select count(a.sifra) from zgrada a inner join vlasnik v on a.vlasnik=v.sifra where a.vlasnik like :uvjet;
			");
...
<html class="no-js" lang="en" dir="ltr">
	...
	<body>
		...
		?>
			...
			<a class="success button expanded" href="unos.php">Unos nove zgrade</a>
		...
		select a.sifra,a.nazivzgrade,a.opis,a.velicina,a.vlasnik,v.ime,v.prezime from zgrada a inner join vlasnik v on a.vlasnik=v.sifra where a.vlasnik like :uvjet
		order by a.nazivzgrade,v.ime,v.prezime limit :odKuda,:poStranici;
		...
		foreach ($rezultati as $red):
			...
			include '../../privatno/zgrade/zgradeecho.php';
