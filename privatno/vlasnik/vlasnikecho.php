<div class="column medium-4 end">
	<ul class="pricing-table no-bullet text-center">
		...
		<li class="description">
			<a class="promjeniv" href="promjeni.php?sifra=<?php echo $red->sifra ?>">
				promjeni
				</a> <a class="obrisiv" href="obrisi.php?sifra=<?php echo $red->sifra ?>">
				obriši
				</a> <a href="#" class="postaviSliku" id="o_<?php echo $red->oibgospodarstva ?>">
				Slika
				</a>
		</li>
	</ul>
