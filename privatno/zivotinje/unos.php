...
if(isset($_POST["dodaj"])){
	...
	if(count($poruke)==0){
		...
		//radi insert
		unset($_POST["dodaj"]);
		$izraz=$veza->prepare("insert into zivotinje 
		(vrsta,imezivotinje,brojmarkice,datumrodenja,kilaza,cijena,zgrada) values 
		(:vrsta,:imezivotinje,:brojmarkice,:datumrodenja,:kilaza,:cijena,:zgrada)");
