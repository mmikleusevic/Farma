...
$uvjet="";
		...
		$poStranici=6;
			...
			$izraz = $veza -> prepare("
			select count(a.sifra) from zivotinje a inner join zgrada b on a.zgrada=b.sifra where a.sifra like :uvjet;
			");
...
<html class="no-js" lang="en" dir="ltr">
	...
	<body>
		...
		?>
			...
			<a class="success button expanded" href="unos.php">Unos nove životinje</a>
		...
		select a.sifra, a.vrsta, a.imezivotinje,a.brojmarkice,a.datumrodenja,a.kilaza,a.cijena,a.zgrada,b.nazivzgrade,v.ime,v.prezime from zivotinje a inner join zgrada b on a.zgrada=b.sifra 
		inner join vlasnik v on b.vlasnik=v.sifra
		where a.sifra like :uvjet
		order by v.ime,v.prezime,a.imezivotinje,a.zgrada,a.vrsta limit :odKuda,:poStranici;
		");
		...
		foreach ($rezultati as $red):
			...
			include '../../privatno/zivotinje/zivotinjeecho.php';
